        ...
        <div id="about">
            <div className="about-section">
                <div className="inner-container shadow-lg rounded-lg" data-aos="fade-up" data-aos-delay={100} data-aos-duration={500}>
                    <h1 className=" text-green-500">{t("hero_title")}</h1>
                    <p className="text">
                        - {" "} {t("desc1")}
                    </p>
                    ...
                    <b className=" text-green-500">{t("desc3_title")}</b>
                    <p className="text">
                        - {" "} {t("desc3")}
                    </p>


                    <b className=" text-green-500">{t("target_title")}</b>
                    <p className="text">
                        - {" "} {t("target_desc1")}
                    </p>
                    <p className="text">
            ...
            <div className="about-section1">
                ...
                <div className="inner-container1 shadow-lg rounded-lg" data-aos="fade-up" data-aos-delay={100} data-aos-duration={500}>
                    <h1 className=" text-green-500">{t("task_title")}</h1>
                    <p className="text">
                        - {" "} {t("task_desc1")}
                    </p>
