            ...
            <Container>
                <div className="flex justify-between items-center py-5 md:py-10" >
                    ...
                    <Link href={`/${locale}/main_all/projects`}>
                        <button className="w-full sm:w-auto px-2 py-1 text-lg text-maincolor bg-white border border-maincolor rounded-md hover:bg-maincolor hover:text-white duration-300">{t("button")}</button>
                    </Link>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                    <ProjectsGet amount={3} />
                </div>
            </Container>
        </div>
    )
