...
const IlmiyEtika = () => {
    ...
    useEffect(() => {
        if (data) {
            setFormData({
                uzTitle: data.data.ilmiy_etika[0]?.translations.uz.title,
                ruTitle: data.data.ilmiy_etika[0]?.translations.ru.title,
                enTitle: data.data.ilmiy_etika[0]?.translations.en.title,
                uzDesc: data.data.ilmiy_etika[0]?.translations.uz.desc,
                ruDesc: data.data.ilmiy_etika[0]?.translations.ru.desc,
                enDesc: data.data.ilmiy_etika[0]?.translations.en.desc,
            });
        }
    }, [data]);
    ...
    return (
        <div className="grid grid-cols-1 gap-4 md:gap-6">
            {data?.data.ilmiy_etika.length >= 1 ? (
                <>
                    ...
                    <div className="mb-5">
                        ...
                        <TipTap
                            content={data?.data.ilmiy_etika[0]?.translations.uz.desc}
                    ...
                    <div className="mb-5">
                        ...
                        <TipTap
                            content={data?.data.ilmiy_etika[0]?.translations.ru.desc}
                    ...
                    <div className="mb-5">
                        ...
                        <TipTap
                            content={data?.data.ilmiy_etika[0]?.translations.en.desc}
                ...
                <Link href={`/${locale}/admin/main/ilmiy_etika/add`}>
                    <button className="p-2 px-4 rounded-lg text-white text-base bg-maincolor">Create Ilmiy etika page</button>
                </Link>
            )}
