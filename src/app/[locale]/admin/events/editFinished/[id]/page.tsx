"use client"
import { eventFinishedGetOneAPI, eventFinishedPostAPI, eventFinishedPutAPI, eventWaitGetOneAPI } from "@/api/AdminRequest";
...
const EditFinished = ({ params }: { params: any }) => {
    const { id } = params;
    ...
    const mutation = useMutation(
        {
            mutationFn: async () => {
                return eventFinishedPutAPI({ ...formData, idWait: id, partners: [...partners] }, id);
            },
            onSuccess: () => {
    ...
    useEffect(() => {
        if (data) {
            setFormData({
                photo: data.data.eventsFinished.photo,
                place: data.data.eventsFinished.place,
                date: data.data.eventsFinished.date,
                uzName: data.data.eventsFinished.translations.uz.name,
                ruName: data.data.eventsFinished.translations.ru.name,
                enName: data.data.eventsFinished.translations.en.name,
                uzForm: data.data.eventsFinished.translations.uz.form,
                ruForm: data.data.eventsFinished.translations.ru.form,
                enForm: data.data.eventsFinished.translations.en.form,
                uzResult: data.data.eventsFinished.translations.uz.result,
                ruResult: data.data.eventsFinished.translations.ru.result,
                enResult: data.data.eventsFinished.translations.en.result,

            });
            setPhotos([...data.data.eventsFinished.photos])
            setPartners([...data.data.eventsFinished.partners])
        }
    }, [data]);
